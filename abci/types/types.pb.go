...
type Request_AnteVerifyTx struct {
	AnteVerifyTx *RequestAnteVerifyTx `protobuf:"bytes,102,opt,name=ante_verify_tx,json=anteVerifyTx,proto3,oneof" json:"ante_verify_tx,omitempty"`
}
...
func (*Request_AnteVerifyTx) isRequest_Value()       {}
...
func (m *Request) GetAnteVerifyTx() *RequestAnteVerifyTx {
	if x, ok := m.GetValue().(*Request_AnteVerifyTx); ok {
		return x.AnteVerifyTx
	}
	return nil
}
...
type RequestAnteVerifyTx struct {
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}

func (m *RequestAnteVerifyTx) Reset()         { *m = RequestAnteVerifyTx{} }
func (m *RequestAnteVerifyTx) String() string { return proto.CompactTextString(m) }
func (*RequestAnteVerifyTx) ProtoMessage()    {}
func (*RequestAnteVerifyTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{10}
}
func (m *RequestAnteVerifyTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestAnteVerifyTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestAnteVerifyTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestAnteVerifyTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestAnteVerifyTx.Merge(m, src)
}
func (m *RequestAnteVerifyTx) XXX_Size() int {
	return m.Size()
}
func (m *RequestAnteVerifyTx) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestAnteVerifyTx.DiscardUnknown(m)
}

var xxx_messageInfo_RequestAnteVerifyTx proto.InternalMessageInfo

func (m *RequestAnteVerifyTx) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
type Response_AnteVerifyTx struct {
	AnteVerifyTx *ResponseAnteVerifyTx `protobuf:"bytes,102,opt,name=ante_verify_tx,json=anteVerifyTx,proto3,oneof" json:"ante_verify_tx,omitempty"`
}
...
func (*Response_AnteVerifyTx) isResponse_Value()       {}
...
func (m *Response) GetAnteVerifyTx() *ResponseAnteVerifyTx {
	if x, ok := m.GetValue().(*Response_AnteVerifyTx); ok {
		return x.AnteVerifyTx
	}
	return nil
}
...
type ResponseAnteVerifyTx struct {
	Code uint32 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Log  string `protobuf:"bytes,2,opt,name=log,proto3" json:"log,omitempty"`
}

func (m *ResponseAnteVerifyTx) Reset()         { *m = ResponseAnteVerifyTx{} }
func (m *ResponseAnteVerifyTx) String() string { return proto.CompactTextString(m) }
func (*ResponseAnteVerifyTx) ProtoMessage()    {}
func (*ResponseAnteVerifyTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{32}
}
func (m *ResponseAnteVerifyTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseAnteVerifyTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseAnteVerifyTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseAnteVerifyTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseAnteVerifyTx.Merge(m, src)
}
func (m *ResponseAnteVerifyTx) XXX_Size() int {
	return m.Size()
}
func (m *ResponseAnteVerifyTx) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseAnteVerifyTx.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseAnteVerifyTx proto.InternalMessageInfo

func (m *ResponseAnteVerifyTx) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseAnteVerifyTx) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RequestAnteVerifyTx)(nil), "tendermint.abci.RequestAnteVerifyTx")
	...
	proto.RegisterType((*RequestBeginRecheckTx)(nil), "tendermint.abci.RequestBeginRecheckTx")
	proto.RegisterType((*RequestEndRecheckTx)(nil), "tendermint.abci.RequestEndRecheckTx")
	...
	proto.RegisterType((*ResponseAnteVerifyTx)(nil), "tendermint.abci.ResponseAnteVerifyTx")
	...
	proto.RegisterType((*ResponseBeginRecheckTx)(nil), "tendermint.abci.ResponseBeginRecheckTx")
	proto.RegisterType((*ResponseEndRecheckTx)(nil), "tendermint.abci.ResponseEndRecheckTx")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	// updated by mssong
	AnteVerifyTx(ctx context.Context, in *RequestAnteVerifyTx, opts ...grpc.CallOption) (*ResponseAnteVerifyTx, error)
}
...
func (c *aBCIApplicationClient) BeginRecheckTx(ctx context.Context, in *RequestBeginRecheckTx, opts ...grpc.CallOption) (*ResponseBeginRecheckTx, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/BeginRecheckTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) EndRecheckTx(ctx context.Context, in *RequestEndRecheckTx, opts ...grpc.CallOption) (*ResponseEndRecheckTx, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/EndRecheckTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) AnteVerifyTx(ctx context.Context, in *RequestAnteVerifyTx, opts ...grpc.CallOption) (*ResponseAnteVerifyTx, error) {
	out := new(ResponseAnteVerifyTx)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/AnteVerifyTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	// updated by mssong
	AnteVerifyTx(context.Context, *RequestAnteVerifyTx) (*ResponseAnteVerifyTx, error)
}
...
func (*UnimplementedABCIApplicationServer) AnteVerifyTx(ctx context.Context, req *RequestAnteVerifyTx) (*ResponseAnteVerifyTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnteVerifyTx not implemented")
}
...
func _ABCIApplication_BeginRecheckTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/BeginRecheckTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ABCIApplication_EndRecheckTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/EndRecheckTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ABCIApplication_AnteVerifyTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestAnteVerifyTx)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).AnteVerifyTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/AnteVerifyTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).AnteVerifyTx(ctx, req.(*RequestAnteVerifyTx))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AnteVerifyTx",
			Handler:    _ABCIApplication_AnteVerifyTx_Handler,
		},
	},
...
func (m *Request_AnteVerifyTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_AnteVerifyTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AnteVerifyTx != nil {
		{
			size, err := m.AnteVerifyTx.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestAnteVerifyTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestAnteVerifyTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestAnteVerifyTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_AnteVerifyTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_AnteVerifyTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AnteVerifyTx != nil {
		{
			size, err := m.AnteVerifyTx.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseAnteVerifyTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseAnteVerifyTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseAnteVerifyTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_AnteVerifyTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestAnteVerifyTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_AnteVerifyTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseAnteVerifyTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 102:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AnteVerifyTx", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestAnteVerifyTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_AnteVerifyTx{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestAnteVerifyTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestAnteVerifyTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestAnteVerifyTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 102:
			...
			v := &ResponseAnteVerifyTx{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_AnteVerifyTx{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseAnteVerifyTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseAnteVerifyTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseAnteVerifyTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
